...
const CaculateTimeDistance: React.FC = () => {
    ...
    return (
        <div>
            <div style={{ display: 'flex', flexDirection: 'column', margin: "10px 20px 20px 20px", width: '650px', height: '300px' }}>
...
export default CaculateTimeDistance;